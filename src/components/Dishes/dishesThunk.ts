...
export const postOneDish = createAsyncThunk<void, IDishForm>(
  'dishes/postOneDish',
  async(oneDish)=>{
...
export const fetchAllDishes = createAsyncThunk<IDishState[], void>(
...
export const fetchOneDish = createAsyncThunk<IDishForm, string>(
  'dishes/fetchOneDish',
  async(dishId)=>{
...
export const deleteDishById = createAsyncThunk<void, IDishState>(
